            ...
            @csrf                              
                <div class="row">
                  <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="id_kategori" class="form-control ps-3 bg-gray-100" placeholder="Masukkan kode kategori/...">
                  </div>
                  <div class="col-md-6">
                    <label for="nama_kategori" class="fw-bold text-dark">Nama Kategori</label>
                    <input type="text" name="nama_kategori" class="form-control ps-3 bg-gray-100" placeholder="Masukkan nama kategori/...">
                  </div>
