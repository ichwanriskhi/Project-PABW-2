            ...
            <div class="row w-100">
                ...
                <div class="col-md-6 split-left d-flex justify-content-center align-items-center text-center">
                    <div>
                        ...
                        <img src="/assets/img/cart.png" alt="Gambar Nailong" class="img-fluid w-100">
                    </div>
                </div>
                <!-- Bagian Kanan -->
                <div class="col-md-6 split-right d-flex justify-content-center">
                    <div class="login-card">
                        ...
                        @endif
                        <form method="POST" action="{{ route('login.penjual.process') }}">
                            @csrf
                            <div class="mb-3 mt-5">
                        ...
                        <div class="text-link text-center mt-3">
                            Sudah memiliki akun? <a href="{{ route('register.penjual') }}" class="text-decoration-none">Daftar disini</a>
                        </div>
                    </div>
                </div>
            </div>
