    ...
    <div class="mt-4">
      <div class="card py-3 px-3">
        ...
        <div class="text-center mt-3">
          <a href="{{ auth()->user()->role === 'admin' ? route('admin.barang.index') : route('petugas.barang.index') }}" class="btn btn-secondary me-2">
          ...
          <form action="
                  {{ auth()->user()->role === 'admin' ? route('admin.update.status', $barang->id_barang) : route('petugas.update.status', $barang->id_barang) }}" method="POST" class="d-inline">
            @csrf
            @method('PATCH')
          ...
          <!-- Form untuk menolak -->
          <form action="{{ auth()->user()->role === 'admin' ? route('admin.update.status', $barang->id_barang) : route('petugas.update.status', $barang->id_barang) }}" method="POST" class="d-inline">
            @csrf
            @method('PATCH')
          ...
          <form action="{{ 
    auth()->user()->role === 'admin' ? route('admin.update.status', $barang->id_barang) : 
    route('petugas.update.status', $barang->id_barang) 
